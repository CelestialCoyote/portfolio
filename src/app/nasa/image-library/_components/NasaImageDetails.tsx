...
// Define the types for the 'image' and 'setDetails' props
interface NasaImageDetailsProps {
	image: {
		links: { href: string }[];
...
const NasaImageDetails: React.FC<NasaImageDetailsProps> = ({ image, setDetails }) => {
	return (
...
// const NasaImageDetails: React.FC = ({ image, setDetails }) => {
// 	return (
// 		<div className="flex flex-col bg-slate-600 rounded-2xl m-2">
// 			<div className="flex gap-6">
// 				<div className="flex w-1/2 items-center p-6">
